...
- [Has per-Agent message queues.](https://www.rabbitmq.com/kubernetes/operator/operator-monitoring)
- [Has a dead letter queue for messages that failed to deliver.](https://www.rabbitmq.com/docs/prometheus)
